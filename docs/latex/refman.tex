...
\input{structImage}
\input{structoption}
\input{structSANE__Device}
\input{structSANE__Option__Descriptor}
\input{structSANE__Parameters}
\input{structSANE__Range}
\chapter{文件说明}
\input{sane_8h}
\input{saneopts_8h}
